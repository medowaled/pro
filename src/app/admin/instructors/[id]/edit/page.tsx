  ...
  useEffect(() => {
    const fetchInstructorData = async () => {
        ...
        try {
            ...
            toast({
                title: 'خطأ',
                description: 'فشل في جلب بيانات المدرب.',
                variant: 'destructive',
            });
        } finally {
            setIsLoading(false);
    ...
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        <div className="flex justify-between items-center">
            <div>
                <CardTitle className="text-2xl font-headline">تعديل بيانات المدرب</CardTitle>
                <CardDescription className="font-body">
                    حدث بيانات المدرب. اترك كلمة المرور فارغة لعدم تغييرها.
                </CardDescription>
            </div>
