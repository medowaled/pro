...
import { ArrowRight, GripVertical, Plus, Trash2, Link as LinkIcon } from 'lucide-react';
    ...
    <Card className="w-full max-w-4xl mx-auto">
      <CardHeader>
        <div className='flex justify-between items-center'>
          <div>
            <CardTitle className="text-2xl font-headline">إضافة دورة جديدة</CardTitle>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Button type="submit" className="w-full" disabled={form.formState.isSubmitting}>
              {form.formState.isSubmitting ? 'جاري الإنشاء...' : 'إنشاء الدورة'}
            </Button>
          </form>
        </Form>
      </CardContent>
