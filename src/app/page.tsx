...
const testimonials = [
  {
    ...
    rating: 5,
    quote:
      'تستحق التقدير والاحترام يا مستر مصطفى من أفضل المدرسين ومتمكن في مادتك وشكرك علي مجهودك الرائع مع اولادي',
  },
  {
    name: 'Ahmed W Sama',
    class: 'طالب',
    ...
    rating: 5,
    quote:
      'احسن مستر علوم علي كوكب الارض بعد عن تجربه تلات سنين عمرنا مازلنا ف الماده بتاعته ابدا وبيكون اب قبل ما يكون معلم ربنا يبارك ف حضرتك يارب',
  },
  {
    name: 'Sama Ashraf',
    class: 'طالبة',
    ...
    rating: 5,
    quote:
      'اجمل مستر كدا كدا بجد وحشتنا وحشتنا الحصص بتاعتك ي مستر واللهي نفسي ف حصه من الحصص بتاعتك تاني يعني من أفضل وانجح المدرسين الي روحتلهم بجد ربنا يوفقك وديما من نجاح ل نجاح ❤️🤍',
  },
];
...
const ScienceBackground = () => {
  const icons = [
    ...
    {
      Icon: FlaskConical,
      size: 'w-10 h-10 sm:w-16 sm:h-16 md:w-20 md:h-20',
      position: 'top-1/2 right-1/4',
    },
    {
      Icon: Dna,
      size: 'w-6 h-6 sm:w-10 sm:h-10 md:w-12 md:h-12',
      position: 'bottom-1/4 left-1/3',
    },
    {
      Icon: Atom,
      size: 'w-8 h-8 sm:w-12 sm:h-12 md:w-10 md:h-10',
      ...
      <main className="flex-grow relative">
          ...
          <div className="responsive-container relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-12">
              ...
              <div className="text-center lg:text-right">
                <h1 className="font-headline text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-2">
                  مستر مصطفى خليل
                </h1>
                <h2 className="font-headline text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-200 dark:text-cyan-300 mb-4">
                  مدرس العلوم المتميز
                </h2>
                <p className="font-body text-base sm:text-lg md:text-xl max-w-xl mx-auto lg:mx-0 mb-6 sm:mb-8">
                  ...
                  العلوم للمرحلة الإعدادية. شرح مبسط - مراجعات قوية – متابعة
                  مستمرة. معانا... الفهم أول خطوة للتفوق.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                  {user ? (
                    <Button
                      asChild
                      size="lg"
                      className="font-headline bg-white text-blue-600 hover:bg-gray-100 dark:bg-yellow-400 dark:text-background dark:hover:bg-yellow-500 rounded-full px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-6 text-base sm:text-lg"
                    >
                      <Link
                        href={
                          user.role === 'ADMIN'
                    ...
                    <>
                      ...
                      <Button
                        ...
                        size="lg"
                        variant="outline"
                        className="font-headline border-white text-white hover:bg-white hover:text-blue-600 dark:border-yellow-400 dark:text-yellow-400 dark:hover:bg-yellow-400 dark:hover:text-background rounded-full px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-6 text-base sm:text-lg"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 max-w-6xl mx-auto">
              ...
              <div className="responsive-card p-6 sm:p-8 text-center flex flex-col items-center border-t-4 border-purple-400 transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <p className="font-body text-foreground/80 mb-4 h-20 text-sm sm:text-base">
                  🎯 ابدأ صح من أول سنة... وافهم العلوم خطوة بخطوة مع أ/ مصطفى
                  خليل
                </p>
                <Link
                  href="/courses?grade=1"
                  className="font-bold text-purple-600 dark:text-purple-400 hover:text-purple-700 transition-colors text-sm sm:text-base"
                >
              ...
              <div className="responsive-card p-6 sm:p-8 text-center flex flex-col items-center border-t-4 border-blue-400 transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <Link
                  ...
                  className="font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 transition-colors text-sm sm:text-base"
                >
              ...
              <div className="responsive-card p-6 sm:p-8 text-center flex flex-col items-center border-t-4 border-green-400 transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl md:col-span-2 lg:col-span-1">
                ...
                <Link
                  ...
                  className="font-bold text-green-600 dark:text-green-400 hover:text-green-700 transition-colors text-sm sm:text-base"
                >
        ...
        <section className="bg-background dark:bg-transparent text-foreground py-12 sm:py-16 md:py-20">
          <div className="responsive-container text-center">
            <h2 className="responsive-heading font-headline font-bold mb-4">
              لماذا تختارني؟
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 mt-8 sm:mt-12 max-w-6xl mx-auto">
              <div className="flex flex-col items-center p-4 sm:p-6 rounded-xl bg-card text-center border border-transparent hover:border-purple-500 transition-colors">
                ...
                <h3 className="font-headline text-lg sm:text-xl lg:text-2xl font-semibold mb-2">
                  نتائج مضمونة
                </h3>
                <p className="font-body text-center text-foreground/80 text-xs sm:text-sm">
              ...
              <div className="flex flex-col items-center p-4 sm:p-6 rounded-xl bg-card text-center border border-transparent hover:border-blue-500 transition-colors">
                ...
                <p className="font-body text-center text-foreground/80 text-xs sm:text-sm">
                  شرح المفاهيم المعقدة بطريقة سهلة
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="responsive-container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <div className="text-center lg:text-right space-y-4">
                <h2 className="font-headline text-2xl sm:text-3xl md:text-4xl font-bold text-primary dark:text-yellow-400">
                  عن أستاذ مصطفى
                </h2>
                <p className="font-body responsive-text text-foreground/80">
                  مدرس علوم متميز مع أكثر من 22 عام من الخبرة في تدريس طلاب
                  المرحلة الإعدادية. متخصص في تبسيط المفاهيم العلمية المعقدة
                  وجعلها سهلة الفهم للطلاب. حاصل على شهادات متقدمة في طرق
                  التدريس الحديثة وتكنولوجيا التعليم. ساعد أكثر من 10,000 طالب
                  في تحسين درجاتهم في مادة العلوم.
                </p>
                <div className="flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-4">
                  <div className="flex items-center gap-2 sm:gap-3 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 font-bold p-2 sm:p-3 rounded-lg text-sm sm:text-base">
                    ...
                    <span>
                      <AnimatedNumber value={22} suffix="+" /> سنة خبرة
                    </span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 font-bold p-2 sm:p-3 rounded-lg text-sm sm:text-base">
                    ...
                    <span>
                      <AnimatedNumber value={10000} suffix="+" /> طالب
                    </span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 font-bold p-2 sm:p-3 rounded-lg text-sm sm:text-base">
                    ...
                    <span>
                      <AnimatedNumber value={95} suffix="%" /> نسبة نجاح
                    </span>
                  </div>
                </div>
              </div>
        ...
        <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-secondary/20 dark:bg-transparent">
          <div className="responsive-container text-center">
            <h2 className="responsive-heading font-headline font-bold mb-2">
              آراء الطلاب
            </h2>
            <p className="responsive-text text-foreground/70 mb-8 sm:mb-12">
              ماذا يقول طلابي عني؟
            </p>
            <Carousel
                    ...
                    <div className="p-1 h-full">
                      <Card className="h-full flex flex-col justify-center items-center text-center shadow-lg bg-card p-4 sm:p-6 md:p-8">
                        <CardContent className="p-4 sm:p-6 flex-grow flex flex-col items-center justify-center">
                          ...
                          <p className="font-body text-foreground/80 italic max-w-md text-sm sm:text-base">
                            "{testimonial.quote}"
                          </p>
                        </CardContent>
                      </Card>
