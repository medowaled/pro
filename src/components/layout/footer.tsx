        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 items-start">
            ...
            <div className="text-right">
              <h3 className="text-2xl font-bold mb-4 text-white font-headline">
                أستاذ مصطفى خليل
              </h3>
              <p className="text-gray-200 leading-relaxed">
                مدرس علوم متميز مع 22 عام من الخبرة في تدريس طلاب المرحلة
                المتوسطة
              </p>
            </div>
            ...
            <div className="text-center">
              <h4 className="text-xl font-semibold mb-4 text-white font-headline">
                تواصل معنا
              </h4>
              <div className="space-y-3 text-gray-200 text-lg flex flex-col items-center">
                <a
                  href="mailto:mostafa3595@gmail.com"
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="text-gray-400 text-xs text-left">
                <p className="font-light">
                  ...
                  <a
                    href="https://wa.me/201202021982?text=مرحبًا،%20محتاج%20استفسر%20عن%20المنصة%20التعليمية."
                    target="_blank"
                    rel="noopener noreferrer"
                    className="font-medium text-white hover:text-blue-300 transition-colors cursor-pointer"
                  >
                    Eng. Ahmed Waleed
                  </a>{" "}
                  and{" "}
